...
export default function DropdownNavSm() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <MenuButton className="text-white mr-10">
            <FontAwesomeIcon icon={faBars} className='text-2xl border-2 py-1 px-3 rounded-lg ' />
        </MenuButton>
      </div>
